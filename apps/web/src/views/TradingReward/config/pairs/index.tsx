...
export const tradingRewardPairConfigChainMap: Record<
  FarmV3SupportedChainId,
  ComputedFarmConfigV3[]
> = {
  // [ChainId.ETHEREUM]: ethFarm,
  // [ChainId.GOERLI]: farm5,
  // [ChainId.MODE_MAINNET]: [...bscFarm, ...tradingRewardV3Pair56],
  [ChainId.MODE_MAINNET]: [...tradingRewardV3Pair56],

  [ChainId.MODE_TESTNET]: farm5,
