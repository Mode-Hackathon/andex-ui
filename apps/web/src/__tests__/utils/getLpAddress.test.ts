...
const CAKE_AS_TOKEN = new ERC20Token(ChainId.MODE_MAINNET, CAKE_AS_STRING, 18, 'CAKE')
const BUSD_AS_TOKEN = new ERC20Token(ChainId.MODE_MAINNET, BUSD_AS_STRING, 18, 'BUSD')
