...
export const V3_MIGRATION_SUPPORTED_CHAINS = [ChainId.MODE_MAINNET, CChainId.MODE_TESTNET]

export const SUPPORT_CAKE_STAKING = [ChainId.MODE_MAINNET, ChainId.MODE_TESTNET]
